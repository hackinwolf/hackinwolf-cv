...
\resumeItem{Developed and implemented automated tools for penetration testing, enhancing the efficiency and accuracy of the testing process.}
...
\resumeItem{Acted as a Subject Matter Expert (SME) on security topics, providing guidance to app teams and colleagues within the pentest team.}
...
\resumeItem{Identified vulnerabilities in iGate and other web apps and implemented preventive and mitigating measures.}
